...
/**
 * The room side of a factory's endpoint. It keeps no state of its own beyond the factory id: items and
 * redstone are relayed to the factory's entrance block, one barrier at a time (see {@link FactoryRelay}).
 */
